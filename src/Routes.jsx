      ...
      <LanguageProvider>
        <ErrorBoundary>
          ...
          <RouterRoutes>
            ...
            <Route path="/" element={<BreedIdentificationDemo />} />
            <Route path="/home-landing" element={<HomeLanding />} />
            <Route path="/contact-and-feedback" element={<ContactAndFeedback />} />
            <Route path="/breed-identification-demo" element={<BreedIdentificationDemo />} />
            <Route path="/supported-breeds-gallery" element={<SupportedBreedsGallery />} />
